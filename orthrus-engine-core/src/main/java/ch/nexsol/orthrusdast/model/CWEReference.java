 ...
 * cover all scanner categories and map directly to OWASP Top 10 (2025).
 */
public enum CWEReference {
	...
	CWE_444("Inconsistent Interpretation of HTTP Requests ('HTTP Request Smuggling')", 444,
			OwaspReference.A06_INSECURE_DESIGN),
	...
	CWE_915("Improperly Controlled Modification of Dynamically-Determined Object Attributes ('Mass Assignment')", 915,
			OwaspReference.A08_INTEGRITY_FAILURES),
	...
	CWE_598("Information Exposure Through Query Strings in GET Request", 598,
			OwaspReference.A04_CRYPTOGRAPHIC_FAILURES),
