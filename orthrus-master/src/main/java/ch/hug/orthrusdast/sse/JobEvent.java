package ch.hug.orthrusdast.sse;
...
public record JobEvent(
        ...
        String target,
        String resultId,     // non-null once COMPLETED
    ...
    public static JobEvent completed(Long jobId, String target, String resultId,
                                      String grade, int totalVulns, long criticalVulns, long highVulns, long mediumVulns, long lowVulns, long infoVulns, int operationsScanned) {
        return new JobEvent(jobId, "COMPLETED", target, resultId,
                "/web/scans/" + resultId + "/pdf",
                grade, totalVulns, criticalVulns, highVulns, mediumVulns, lowVulns, infoVulns, operationsScanned,
                "Scan completed!");
    }

    public static JobEvent failed(Long jobId, String target, String reason) {
        return new JobEvent(jobId, "FAILED", target, null, null, null, 0, 0, 0, 0, 0, 0, 0,
                "Scan failed: " + reason);
    }
}
