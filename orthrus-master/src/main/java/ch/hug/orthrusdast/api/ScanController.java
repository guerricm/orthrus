...
public class ScanController {
    ...
    public ScanController(OAuth2TokenFetcher tokenFetcher, ch.hug.orthrusdast.repository.ScanJobRepository scanJobRepository, tools.jackson.databind.ObjectMapper objectMapper) {
                ...
                .flatMap(fetchedTokens -> {
                    ...
                    try {
                        ...
                        ch.hug.orthrusdast.entity.ScanJobEntity job = new ch.hug.orthrusdast.entity.ScanJobEntity(
                                request.discovererId(), request.target(), configJson, ch.hug.orthrusdast.model.JobStatus.PENDING
                        );
