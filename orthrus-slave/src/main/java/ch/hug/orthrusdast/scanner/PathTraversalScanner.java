                ...
                .flatMapMany(response -> {
                    ...
                    if (linuxVuln || windowsVuln) {
                         Vulnerability vuln = createVulnerabilityWithTrace(
                            ...
                            "Validate input against an allowlist. Avoid passing raw user input to filesystem APIs. Use path canonicalization and verify the target path is within the expected directory.", testOp, response,
