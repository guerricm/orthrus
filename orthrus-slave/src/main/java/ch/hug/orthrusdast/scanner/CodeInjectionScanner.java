            ...
            return httpClient.send(testOp).flatMapMany(response -> {
                ...
                if (response.bodyContains("999999")) {
                    Vulnerability vuln = createVulnerabilityWithTrace(
                            ...
                            "Never pass untrusted data directly to eval() or similar dynamic execution functions. Use safe parsers and avoid dynamic code execution entirely.", testOp, response,
