...
class ScannerIntegrationTests {
    ...
    void testSqlInjectionScanner() {
        SqlInjectionScanner scanner = new SqlInjectionScanner(httpClient, 
            new ch.hug.orthrusdast.scanner.payload.PayloadLoaderService(),
            new ch.hug.orthrusdast.scanner.payload.PayloadMutator(),
            new ch.hug.orthrusdast.scanner.oast.InteractshClient());
