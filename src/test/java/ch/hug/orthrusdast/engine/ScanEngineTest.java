...
class ScanEngineTest {
    ...
    void testExecuteScan_LimitsConcurrency() {
        ...
        SecurityScanner mockScanner = new SecurityScanner() {
            ...
            @Override
            public Flux<ch.hug.orthrusdast.model.Vulnerability> scan(Operation operation) {
                return scan(operation, null);
            }

            @Override
            public Flux<ch.hug.orthrusdast.model.Vulnerability> scan(Operation operation, ScanConfiguration config) {
        ...
        ch.hug.orthrusdast.ingestion.EndpointDiscoverer mockDiscoverer = new ch.hug.orthrusdast.ingestion.EndpointDiscoverer() {
            @Override
