...
public class SecurityHeadersScanner implements SecurityScanner {
    ...
    private void checkHeader(ch.hug.vulnapi.http.ScanHttpResponse response, String headerName, String shortName, CWEReference cwe, Operation operation, List<Vulnerability> vulns) {
